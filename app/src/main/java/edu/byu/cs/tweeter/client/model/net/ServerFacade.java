...
public class ServerFacade {
    ...
    private static final String SERVER_URL = "https://kfcmszc2f3.execute-api.us-east-2.amazonaws.com/test";
    ...
    public CountResponse getFollowerCount(FollowerCountRequest request, String urlPath)
            throws IOException, TweeterRemoteException{
